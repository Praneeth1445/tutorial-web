...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('https://images.pexels.com/photos/20422132/pexels-photo-20422132/free-photo-of-sauces-and-meal-on-plate.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'); 
    ...
    <div class="table-container">
        <table>
            ...
            <?php
                ...
                $error = ''; 
                $sql = "SELECT * FROM food WHERE foodtype='breakfast'";
