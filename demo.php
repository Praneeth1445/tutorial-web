<?php
    ...
    // $username = htmlspecialchars($_SESSION['username']); // Not used anymore
    // Retrieve user avatar URL from session or use a default
    $avatarUrl = isset($_SESSION['avatar']) ? htmlspecialchars($_SESSION['avatar']) : 'https://media1.fdncms.com/tucsonweekly/imager/u/slideshow/21818921/quick_bites.jpg.png';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
            ...
            <ul>
                ...
                <li>
                    <div class="user-menu" tabindex="0" aria-haspopup="true" aria-expanded="false">
                        ...
                        <!-- Updated Greeting with Icon and Bold Text -->
                        <span class="greeting">
                            <i class="https://media1.fdncms.com/tucsonweekly/imager/u/slideshow/21818921/quick_bites.jpg.png"></i> <!-- Icon before the text -->
                            Hello Sai!
                        </span>
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; 2023 Quick Bites. All rights reserved.</p>
    </footer>
