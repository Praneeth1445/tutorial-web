...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background-image: url('https://images.pexels.com/photos/10580197/pexels-photo-10580197.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'); 
    ...
    <div class="table-container">
        <table>
            ...
            <?php
                ...
                $error = ''; 
                $sql = "SELECT * FROM food WHERE foodtype='lunch'";
